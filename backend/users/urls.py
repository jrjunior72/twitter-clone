...
urlpatterns = [
    ...
    # 🔥 CORRIJA A ORDEM E ADICIONE UPDATE_PROFILE
    path('profile/me/', views.get_profile, name='get-profile'),           # GET /api/auth/profile/me/
    path('profile/update/', views.update_profile, name='update-profile'), # PATCH /api/auth/profile/update/
